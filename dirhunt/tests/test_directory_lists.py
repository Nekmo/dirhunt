...
class TestApacheDirectoryLists(DirectoryListsTestBase, unittest.TestCase):
    ...
    def test_is_applicable(self):
        ...
        self.assertTrue(
            ApacheDirectoryList.is_applicable(
                self.html, self.get_crawler_url(), beautiful_soup
            )
        )
    ...
    def test_is_not_applicable(self):
        ...
        self.assertFalse(
            ApacheDirectoryList.is_applicable(
                TestCommonDirectoryList.html, self.get_crawler_url(), beautiful_soup
            )
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                (
                    ...
                    {"created_at": "2018-02-16 14:29", "filesize": "16K"},
                ),
                (
                    "http://domain.com/path/bookmark-template.php",
                    {"created_at": "2018-02-16 14:29", "filesize": "11K"},
                ),
            ],
        )
...
class TestCommonDirectoryList(DirectoryListsTestBase, unittest.TestCase):
    ...
    def test_is_applicable(self):
        beautiful_soup = self.get_beautiful_soup()
        self.assertTrue(
            CommonDirectoryList.is_applicable(
                self.html, self.get_crawler_url(), beautiful_soup
            )
        )
